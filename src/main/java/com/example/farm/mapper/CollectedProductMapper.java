...
public class CollectedProductMapper {
     ...
     * Количество одинаковых товаров у одного и того же работника складывается, благодаря чему
     * выводится только один JSON у одного товара с общим количеством этого товара у работника.
